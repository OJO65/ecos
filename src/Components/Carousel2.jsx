...
const Carousel2 = () => {
  const carouselItems = [
    ...
    },
    {
      href: "https://www.jumia.co.ke/",
      imgSrc: vitronRadio,
      Name: "Vitron V636 Radio ",
      Newprice: "Ksh 1,199",
      Oldprice: "Ksh 1,499",
      discount: "-20%",
      alt: "Vitron V636 Radio",
    },
    {
      href: "https://www.jumia.co.ke/",
      imgSrc: villaonPhone,
      Name: "Villaon Caffe Phone",
      Newprice: "Ksh 1,539",
      Oldprice: "Ksh 1,899",
      discount: "-19%",
      alt: "Villaon Caffe Phone",
    },
    {
      href: "https://www.jumia.co.ke/",
      imgSrc: samsungPhone,
    ...
    },
    {
      href: "https://www.jumia.co.ke/",
      imgSrc: hikers43,
      Name: "Hikers SmartTv 43' ",
      Newprice: "Ksh 19,299",
      Oldprice: "Ksh 40,499",
      discount: "-52%",
      alt: "Hikers SmartTv 43' ",
    },
    {
      href: "https://www.jumia.co.ke/",
      ...
      Oldprice: "Ksh 1,599",
      discount: "-19%",
      alt: "Ailyons Electric Kettle",
    },
    {
      href: "https://www.jumia.co.ke/",
      imgSrc: skyworthTv,
      Name: "Skyworth 43 Inch",
      Newprice: "Ksh 22,999",
      Oldprice: "Ksh 35,999",
      discount: "-36%",
      alt: "Skyworth 43 Inch",
    },
    {
      href: "https://www.jumia.co.ke/",
    ...
    >
      <div className="aspect-w-1 shadow-lg aspect-h-1 w-[193.33px] relative">
        <img
          ...
          alt={item.alt}
        />
        <span className="absolute -top-3 ml-40 text-red-600 bg-slate-200">
          {item.discount}
        </span>
      </div>
